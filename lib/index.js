  ...
  const section = (group) => {
    ...
    const rows = group.files.map((f) => {
      ...
      const viewHref = previewable
        ? (isPdf ? `workspace-file?path=${rel}&inline=1` : `workspace-preview?path=${rel}&from=list`)
...
<style>
  * { box-sizing: border-box; }
  ...
  .md h1,.md h2,.md h3,.md h4,.md h5,.md h6 { line-height:1.3; margin:1.2em 0 .5em; }
  .md h1 { font-size:1.5em; border-bottom:1px solid var(--lp-border); padding-bottom:.3em; }
  .md h2 { font-size:1.3em; border-bottom:1px solid var(--lp-border); padding-bottom:.2em; }
  .md h3 { font-size:1.15em; }
  .md h1:first-child,.md h2:first-child,.md h3:first-child { margin-top:.2em; }
  .md p { margin:.6em 0; }
