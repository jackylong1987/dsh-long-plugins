...
<div style="position:sticky;top:0;z-index:20;display:flex;gap:6px;padding:8px 12px;align-items:center;flex-wrap:wrap;background:#1a2530">
  ...
  <span style="display:flex;gap:4px;align-items:center;color:#9ca3af;font-size:12px">
    ...
    <button type="button" title="实际大小" onclick="zoom100()" style="padding:4px 9px;border:1px solid #2c3a47;border-radius:7px;color:#e5e7eb;background:transparent;font-size:12px;cursor:pointer">100%</button>
  </span>
...
function dw(){
  ...
  if(host) host.style.width='max-content';
  return host || c;
}
function applyZoom(){
