...
<style>
 ...
 @media (max-width:767px){
   ...
   #container .docx-wrapper > .docx,
   #container .docx-wrapper > section.docx,
   #container .docx-wrapper section.docx{max-width:100%;margin:0 0 12px;padding:22px 14px;min-height:0}
 }
</style>
</head><body>
...
<style>
  * { box-sizing: border-box; }
  ...
  .bar { position:sticky; top:0; z-index:20; display:flex; align-items:center; gap:12px; padding:10px 16px; background:var(--lp-bar-bg); border-bottom:1px solid var(--lp-border); }
